...
def data_preprocess():
    filepath = '/home/tvaspar/DL_HW2/MLDS_hw2_1_data/'
...
def annotate(label_file, word_dict, w2i):
    label_json = '/home/tvaspar/DL_HW2/MLDS_hw2_1_data/' + label_file
    annotated_caption = []
...
def avi(files_dir):
    avi_data = {}
    training_feats = '/home/tvaspar/DL_HW2/MLDS_hw2_1_data/' + files_dir
